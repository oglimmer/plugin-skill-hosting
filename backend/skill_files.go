...
// pathParam pulls the wildcard tail from a URL like /files/scripts/foo.py.
...
func snapshotSkillFiles(ctx context.Context, tx dbExec, skillVersionID, skillID string) error {
...
func restoreSkillFilesFromVersion(ctx context.Context, tx dbExec, skillID, skillVersionID string) error {
